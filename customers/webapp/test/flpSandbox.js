			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apcustomers-display": {
								"semanticObject": "apcustomers",
								"action": "display",
								"description": "SAPUI5 app of Customers service in SAP S4 HANA",
								"title": "Customers",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.customers",
									"url": sap.ui.require.toUrl("ap/customers")
								}
							}
						}
					}
