		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customers",
									"targetURL": "#apcustomerapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apcustomerapplication-display": {
								"semanticObject": "apcustomerapplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.customerapplication",
									"url": sap.ui.require.toUrl("ap/customerapplication")
								}
							}
						}
					}
